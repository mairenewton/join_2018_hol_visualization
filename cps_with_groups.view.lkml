include: "cps_voter_supp_measure.view.lkml"
view: cps_with_groups {
  label: "Voter Data"
  extends: [CPS_Voting_and_Registration_Measures]
  ...
  filter: select_raw_age {
    label: "Age"
    view_label: "Group Demographic Variables"
    suggest_dimension: raw_age
  }

  measure: percent_of_population_in_cohort {
    sql: 1.0 * ${group_population}/${cohort_population} ;;
    value_format_name: percent_2
    view_label: "Populations"
    type: number
  }

  measure: percent_of_households_in_cohort {
    sql: 1.0 * ${group_households}/${households_in_cohort} ;;
    value_format_name: percent_2
    view_label: "Populations"
    type: number
  }

  #     - measure: percent_of_families_in_cohort
  #       sql: 1.0 * ${group_families}/${families_in_cohort}
  #       value_format_name: percent_2
  #       view_label: Populations
  #       type: number
  ...
  filter: select_white_yesno {
    label: "White, Non-Hispanic (Yes/No)"
    suggest_dimension: white_yesno
    type: string
    view_label: "Group Demographic Variables"
  }

  filter: select_prhspnon_yesno {
    label: "Hispanic origin (Yes/No)"
    view_label: "Group Demographic Variables"
    type: string
    suggest_dimension: prhspnon_yesno
  }
  ...
  filter: select_metro_status {
    label: "Metropolitan Status"
    view_label: "Group Geography Variables"
    suggest_dimension: metro_status
  }
    ...
    case: {
      when: {
        sql: (${TABLE}.pes5 = -9
          ...
          or
          (${TABLE}.pes4_census_2000 = -9
          AND ${TABLE}.src_table = 'census_2000')
           ;;
        label: "No answer"
      }
  ...
  filter: select_in_person_mail {
    label: "Did you vote in person or did you vote by mail?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: in_person_mail
  }
  ...
  filter: select_on_or_before {
    label: "Did you vote on Election Day or before?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: on_or_before
  }
  ...
  filter: select_when_obtained_license {
    label: "Did you register when you obtained or renewed license or another way?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: when_obtained_license
  }
  ...
  filter: select_registered {
    label: "Were you registered to vote in the November election?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: registered
  }
  ...
  filter: select_time_at_address {
    label: "How long have you been at your current address?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: time_at_address
  }
  ...
  filter: select_race_hisp {
    label: "Race With Hispanic"
    view_label: "Group Demographic Variables"
    suggest_dimension: race_hisp
  }
  ...
  filter: select_register_after_1995 {
    label: "Did you register to vote after January 1, 1995?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: register_after_1995
  }
  ...
  filter: select_how_register {
    label: "How did you register to vote?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: how_register
  }
  ...
  filter: select_why_not_vote {
    label: "Main reason you did not vote?"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: why_not_vote
  }
  ...
  filter: select_eligible_vote_yesno {
    label: "Were you eligible to vote in the November election? (Yes/No)"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: eligible_vote_yesno
  }
  ...
  filter: select_registered_recode_yesno {
    label: "Were you registered to vote in the November election? (Yes/No)"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: registered_recode_yesno
  }
  ...
  filter: select_voted_recode {
    label: "Did you vote in the November election? (Yes/No)"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: voted_recode
  }
  ...
  dimension: obama_coalition {
    ...
    sql: CASE WHEN
      ...
      END
       ;;
    description: "As defined by media (person of color, or under 30, or making less than $15k)"
  }

  filter: select_obama_coalition {
    label: "Member of the Obama Coalition (Yes/No)"
    view_label: "Group Voting and Registration Supplement Variables"
    suggest_dimension: obama_coalition
    description: "As defined by media (person of color, or under 30, or making less than $15k)"
  }
  ...
  dimension: weekly_earnings_all {
    hidden: yes
    type: number
    view_label: "Cohort Earnings Variables"
    sql: CASE WHEN ${TABLE}.PTWERNA between 0.0 AND 288.61 AND ${TABLE}.HRMIS IN (4,8)
      AND ${TABLE}.PTERNHLY between 0.0 AND 288.61 AND ${TABLE}.HRMIS IN (4,8)
      CONCAT(${TABLE}.PTWERNA, ${TABLE}.PTERNHLY)
      ELSE -1
      END
       ;;
  }
  ...
  dimension: yearly_earnings_all {
    label: "Yearly earnings All"
    tiers: [
      0,
      15000,
      30000,
    ...
    sql: CASE WHEN ${TABLE}.PTERNWA not in (0, 21474836.47) AND ${TABLE}.HRMIS in (4, 8)
      AND ${TABLE}.PTERNHLY not in (0, 21474836.47) AND ${TABLE}.HRMIS in (4, 8)
      THEN (CONCAT(${TABLE}.PTWERNA, ${TABLE}.PTERNHLY)) *52
      ELSE -1
      END
       ;;
  }

  filter: select_yearly_earnings {
    label: "Yearly earnings"
    view_label: "Group Earnings Variables"
    suggest_dimension: yearly_earnings
  }
  ...
  filter: select_education5 {
    label: "Education (5 Categories)"
    view_label: "Group Demographic Variables"
    suggest_dimension: education5
  }
  ...
  filter: select_education4 {
    label: "Education (4 Categories)"
    view_label: "Group Demographic Variables"
    suggest_dimension: education4
  }
  ...
  filter: select_generation {
    label: "Generation Name"
    view_label: "Group Demographic Variables"
    suggest_dimension: generation
  }
      ...
      when: {
        sql: ${white_yesno} = 'Yes' AND
          ${education5} not in ('Less than a high school diploma', 'High school diploma, no college')
           ;;
        label: "White and College Educated"
      }
  ...
  filter: select_demo_group {
    label: "Demographic Groups Recode (5 groups)"
    view_label: "Group Demographic Variables"
    suggest_dimension: demo_group
  }

  dimension: prnlfsch {
    label: "In School/Not in School (not in labor force)"
    view_label: "Cohort School Enrollment Variables"
  }

  filter: select_prnlfsch {
    label: "In School/Not in School (not in labor force)"
    view_label: "Group School Enrollment Variables"
  }
  ...
  filter: select_peschenr_yesno {
    label: "In High School/College/University (Yes/No)"
    view_label: "Group School Enrollment Variables"
    suggest_dimension: peschenr_yesno
  }
  ...
  filter: select_peafever_yesno {
    label: "Ever serve active duty in military (Yes/No)"
    view_label: "Group Demographic Variables"
    suggest_dimension: peafever_yesno
  }
  ...
  filter: select_msa_size {
    label: "Metropolitan Statistical Area size"
    view_label: "Group Geography Variables"
    suggest_dimension: msa_size
  }
  ...
  filter: select_family_income {
    label: "Total family income in past 12 months"
    view_label: "Group Earnings Variables"
    suggest_dimension: family_income
  }
  ...
  measure: cohort_population {
    label: "People in Cohort"
  }

  measure: households_in_cohort {
    type: sum
  ...
  measure: group_population {
    ...
    sql: CASE WHEN
      ...
      AND {% condition select_peschenr_yesno %} ${peschenr_yesno} {%endcondition%}
      ...
      AND {% condition select_why_not_vote %} ${why_not_vote} {%endcondition%}
      ...
      AND {% condition select_metro_status %} ${metro_status} {%endcondition%}
      AND {% condition select_race %} ${race} {%endcondition%}
      AND {% condition select_race_hisp %} ${race_hisp} {%endcondition%}
      AND {% condition select_register_after_1995 %} ${register_after_1995} {%endcondition%}
      AND {% condition select_in_person_mail %} ${in_person_mail} {%endcondition%}
      AND {% condition select_on_or_before %} ${on_or_before} {%endcondition%}
      AND {% condition select_when_obtained_license %} ${when_obtained_license} {%endcondition%}
      AND {% condition select_registered %} ${registered} {%endcondition%}
      AND {% condition select_time_at_address %} ${time_at_address} {%endcondition%}
      AND {% condition select_how_register %} ${how_register} {%endcondition%}
      AND {% condition select_eligible_vote_yesno %} ${eligible_vote_yesno} {%endcondition%}
      AND {% condition select_voted_recode %} ${voted_recode} {%endcondition%}
      AND {% condition select_registered_recode_yesno %} ${registered_recode_yesno} {%endcondition%}
      AND {% condition select_white_yesno %} ${white_yesno} {%endcondition%}
      AND {% condition select_prhspnon_yesno %} ${prhspnon_yesno} {%endcondition%}
      AND {% condition select_obama_coalition %} ${obama_coalition} {%endcondition%}
      AND {% condition select_education5 %} ${education5} {%endcondition%}
      AND {% condition select_education4 %} ${education4} {%endcondition%}
      AND {% condition select_demo_group %} ${demo_group} {%endcondition%}
      AND {% condition select_generation %} ${generation} {%endcondition%}
      AND {% condition select_yearly_earnings %} ${yearly_earnings} {%endcondition%}
      AND {% condition select_peafever_yesno %} ${peafever_yesno} {%endcondition%}
      ...
      AND {% condition select_raw_age %} ${raw_age} {%endcondition%}
      AND {% condition select_msa_size %} ${msa_size} {%endcondition%}
  ...
  measure: group_population_owning {
    label: "People in Group Owning"
    type: sum
    view_label: "Populations"

    filters: {
      field: cps_with_groups.hetenure
  ...
  measure: group_households {
    label: "Households in Group"
    type: sum
    view_label: "Populations"
    value_format_name: decimal_0
    sql: CASE WHEN
      ...
      AND {% condition select_msa_size %} ${msa_size} {%endcondition%}
      AND {% condition select_gtcsa %} ${gtcsa} {%endcondition%}
      AND {% condition select_family_income %} ${family_income} {%endcondition%}
      AND {% condition select_peafwhen %} ${peafwhen} {%endcondition%}
      AND {% condition select_peafwhn1 %} ${peafwhn1} {%endcondition%}
      AND {% condition select_peafwhn2 %} ${peafwhn2} {%endcondition%}
      AND {% condition select_peafwhn3 %} ${peafwhn3} {%endcondition%}
